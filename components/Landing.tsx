...
export default function Landing({ google, discord, loading }: any) {
  return (
        ...
        <div className="px-6 py-12 flex flex-col justify-between lg:justify-center max-w-md">
          <div className="top">
            ...
            <Paragraph className="pt-4" alignment="centered">
              Journi is a tiny AI powered everyday journal that helps you build
              a journaling habit by asking you 3 questions on how you are
              feeling.
            </Paragraph>
          </div>
